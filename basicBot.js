...
(function () {
    ...
    var loadChat = function (cb) {
        ...
        $.get("https://cdn.jsdelivr.net/gh/CasaDoRock/Bot/lang/langIndex.json", function (json) {
        ...
        commands: {
            ...
            cookieCommand: {
                ...
                cookies: ['te deu um biscoito de chocolate!',
                    'te deu uma bolacha caseira de aveia',
                    ...
                    'te deu um biscoito da sorte. Está escrito "Tenta, vai que cola!"',
                    ...
                    'te deu uma bolacha de ouro. Você não consegue comer porque é feito de ouro.',
